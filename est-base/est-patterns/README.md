...
EST Patterns 鏄?EST 妗嗘灦鐨勮璁℃ā寮忔ā鍧楋紝鎻愪緵浜嗗父鐢ㄨ璁℃ā寮忕殑寮€绠卞嵆鐢ㄥ疄鐜帮紝甯姪浣犵紪鍐欐洿浼橀泤銆佹洿鍙淮鎶ょ殑浠ｇ爜銆?
...
- [蹇€熷叆闂╙(#蹇€熷叆闂?
- [鍩虹绡囷細鍒涘缓鍨嬫ā寮廬(#鍩虹绡囧垱寤哄瀷妯″紡)
- [鍩虹绡囷細缁撴瀯鍨嬫ā寮廬(#鍩虹绡囩粨鏋勫瀷妯″紡)
- [杩涢樁绡囷細琛屼负鍨嬫ā寮廬(#杩涢樁绡囪涓哄瀷妯″紡)
- [鏈€浣冲疄璺礭(#鏈€浣冲疄璺?
...
鎯宠薄浣犲湪鍋氳彍锛屾瘡娆″仛绾㈢儳鑲夐兘鐢ㄥ悓鏍风殑姝ラ锛氬垏鑲夈€佺劘姘淬€佺倰绯栬壊銆佺倴鐓?.. 杩欎釜鍥哄畾鐨?鑿滆氨"灏辨槸涓€绉嶆ā寮忋€?

**璁捐妯″紡**灏辨槸缂栫▼涓殑"鑿滆氨"锛屾槸鍓嶄汉鎬荤粨鍑烘潵鐨勮В鍐崇壒瀹氶棶棰樼殑鏈€浣冲疄璺点€?

### 5鍒嗛挓涓婃墜

璁╂垜浠粠鏈€甯哥敤鐨?*鍗曚緥妯″紡**寮€濮嬶細
...
鍒涘缓鍨嬫ā寮忓氨鍍?鐢熶骇杞﹂棿"锛屼笓闂ㄨ礋璐?鐢熶骇"瀵硅薄銆?

### 1. 鍗曚緥妯″紡 (Singleton)

**鍦烘櫙**锛氱彮绾ч噷鍙湁涓€涓彮闀匡紝澶у閮芥壘浠栨眹鎶ュ伐浣溿€?
...
**鍦烘櫙**锛氬幓椁愬巺鍚冮キ锛屼綘鍛婅瘔鏈嶅姟鍛?鏉ヤ竴浠藉淇濋浮涓?锛屽悗鍘ㄥ氨缁欎綘鍋氬ソ浜嗭紝浣犱笉鐢ㄥ叧蹇冩€庝箞鍋氱殑銆?
...
**鍦烘櫙**锛氱粍瑁呯數鑴戯紝浣犲彲浠ラ€夋嫨涓嶅悓鐨?CPU銆佸唴瀛樸€佺‖鐩?.. 鑷敱缁勫悎銆?
...
class Computer {
    ...
    public String toString() {
        return "鐢佃剳閰嶇疆: CPU=" + cpu + ", 鍐呭瓨=" + memory + ", 纭洏=" + storage;
    }
...
缁撴瀯鍨嬫ā寮忓氨鍍?瑁呬慨甯堝倕"锛屽府浣犳妸涓滆タ缁勫悎鍦ㄤ竴璧枫€?

### 1. 瑁呴グ鍣ㄦā寮?(Decorator)

**鍦烘櫙**锛氫拱鍜栧暋锛屽彲浠ュ姞绯栥€佸姞濂躲€佸姞鐝嶇彔... 鎯冲姞浠€涔堝氨鍔犱粈涔堛€?
...
public class DecoratorExample {
    public static void main(String[] args) {
        ...
        System.out.println(coffee.getDescription() + " 浠锋牸: " + coffee.getCost());
...
class MilkDecorator extends AbstractDecorator<Coffee> implements Coffee {
    ...
    @Override
    public String getDescription() {
        return decorated.getDescription() + " + 鐗涘ザ";
    }
...
class SugarDecorator extends AbstractDecorator<Coffee> implements Coffee {
    ...
    @Override
    public String getDescription() {
        return decorated.getDescription() + " + 绯?;
    }
...
琛屼负鍨嬫ā寮忓氨鍍?娌熼€氬崗璋冨憳"锛屽府瀵硅薄涔嬮棿鏇村ソ鍦版矡閫氥€?

### 1. 瑙傚療鑰呮ā寮?(Observer)

**鍦烘櫙**锛氬井淇＄兢鑱婏紝缇や富鍙戞秷鎭紝鎵€鏈変汉閮借兘鏀跺埌銆?
...
public class ObserverExample {
    public static void main(String[] args) {
        ...
        // 鍔犲叆鎴愬憳
        group.addMember(new Member("灏忔槑"));
        group.addMember(new Member("灏忕孩"));
        group.addMember(new Member("灏忓垰"));
        
        // 缇や富鍙戞秷鎭?
        group.sendMessage("浠婃櫄8鐐瑰紑浼氾紒");
    }
}
...
**鍦烘櫙**锛氬嚭琛屾柟寮忥紝鍙互閫夋嫨姝ヨ銆侀獞杞︺€佸紑杞?.. 鎯虫€庝箞鍘诲氨鎬庝箞鍘汇€?
...
public class StrategyExample {
    public static void main(String[] args) {
        ...
        // 鏍规嵁鎯呭喌閫夋嫨绛栫暐
        System.out.println(context.execute("walk", "鍏徃"));
        System.out.println(context.execute("bike", "瓒呭競"));
...
public class CollectionIntegration {
    public static void main(String[] args) {
        // 鐢?Collection 绠＄悊瑙傚療鑰?
        Seqs.of(new Member("灏忔槑"), new Member("灏忕孩"))
            .forEach(member -> System.out.println("鍔犲叆: " + member.getId()));
    }
}
```
