...
public final class Assertions {
    ...
    public static void assertEqualsWithDelta(double expected, double actual, double delta) {
        assertEqualsWithDelta(expected, actual, delta, (String) null);
    }

    public static void assertEqualsWithDelta(double expected, double actual, double delta, String message) {
