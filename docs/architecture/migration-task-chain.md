...
### 任务 2.1: 重命名 est-foundation 为 est-base
```
git mv est-foundation est-base
# 更新所有 pom.xml 中的模块引用
git add .
git commit -m "refactor: 重命名 est-foundation 为 est-base"
```
...
### 任务 3.9: 调整包名为 ltd.idcu.est.core.[能力]
```
git add .
git commit -m "refactor: 调整包名为 ltd.idcu.est.core.[能力]"
```
...
### 任务 4.1: 重命名 est-features-cache 为 est-cache
```
git mv est-features/est-features-cache est-modules/est-cache
git add .
git commit -m "refactor: 重命名 est-features-cache 为 est-cache"
```

### 任务 4.2: 重命名 est-features-logging 为 est-logging
```
git mv est-features/est-features-logging est-modules/est-logging
git add .
git commit -m "refactor: 重命名 est-features-logging 为 est-logging"
```

### 任务 4.3: 重命名 est-features-data 为 est-data
```
git mv est-features/est-features-data est-modules/est-data
git add .
git commit -m "refactor: 重命名 est-features-data 为 est-data"
```

### 任务 4.4: 重命名 est-features-security 为 est-security
```
git mv est-features/est-features-security est-modules/est-security
git add .
git commit -m "refactor: 重命名 est-features-security 为 est-security"
```

### 任务 4.5: 重命名 est-features-messaging 为 est-messaging
```
git mv est-features/est-features-messaging est-modules/est-messaging
git add .
git commit -m "refactor: 重命名 est-features-messaging 为 est-messaging"
```

### 任务 4.6: 重命名 est-features-monitor 为 est-monitor
```
git mv est-features/est-features-monitor est-modules/est-monitor
git add .
git commit -m "refactor: 重命名 est-features-monitor 为 est-monitor"
```

### 任务 4.7: 重命名 est-features-scheduler 为 est-scheduler
```
git mv est-features/est-features-scheduler est-modules/est-scheduler
git add .
git commit -m "refactor: 重命名 est-features-scheduler 为 est-scheduler"
```

### 任务 4.8: 重命名 est-features-event 为 est-event
```
git mv est-features/est-features-event est-modules/est-event
git add .
git commit -m "refactor: 重命名 est-features-event 为 est-event"
```

### 任务 4.9: 重命名 est-features-circuitbreaker 为 est-circuitbreaker
```
git mv est-features/est-features-circuitbreaker est-modules/est-circuitbreaker
git add .
git commit -m "refactor: 重命名 est-features-circuitbreaker 为 est-circuitbreaker"
```

### 任务 4.10: 重命名 est-features-discovery 为 est-discovery
```
git mv est-features/est-features-discovery est-modules/est-discovery
git add .
git commit -m "refactor: 重命名 est-features-discovery 为 est-discovery"
```

### 任务 4.11: 重命名 est-features-config 为 est-config
```
git mv est-features/est-features-config est-modules/est-config
git add .
git commit -m "refactor: 重命名 est-features-config 为 est-config"
```

### 任务 4.12: 重命名 est-features-performance 为 est-performance
```
git mv est-features/est-features-performance est-modules/est-performance
git add .
git commit -m "refactor: 重命名 est-features-performance 为 est-performance"
```

### 任务 4.13: 重命名 est-features-hotreload 为 est-hotreload
```
git mv est-features/est-features-hotreload est-modules/est-hotreload
git add .
git commit -m "refactor: 重命名 est-features-hotreload 为 est-hotreload"
```

### 任务 4.14: 重命名 est-features-ai 为 est-ai
```
git mv est-features/est-features-ai est-modules/est-ai
git add .
git commit -m "refactor: 重命名 est-features-ai 为 est-ai"
```
...
### 任务 4.18: 创建 est-modules 目录的 pom.xml
```
git add .
git commit -m "feat: 创建 est-modules 目录的 pom.xml"
```

### 任务 4.19: 将所有功能模块移到 est-modules
```
git add .
git commit -m "refactor: 将所有功能模块移到 est-modules"
```
...
### 任务 5.1: 创建 est-app 目录的 pom.xml
```
git add .
git commit -m "feat: 创建 est-app 目录的 pom.xml"
```
...
### 任务 6.1: 重命名 est-tools/est-db-generator 为 est-tools/est-codegen
```
git mv est-tools/est-db-generator est-tools/est-codegen
git add .
git commit -m "refactor: 重命名 est-tools/est-db-generator 为 est-tools/est-codegen"
```
...
### 任务 6.4: 重命名 est-tools/est-migration-tool 为 est-tools/est-migration
```
git mv est-tools/est-migration-tool est-tools/est-migration
git add .
git commit -m "refactor: 重命名 est-tools/est-migration-tool 为 est-tools/est-migration"
```
