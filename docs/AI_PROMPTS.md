...
请参考EST的PERFORMANCE_TUNING_GUIDE.md，提供详细的性能优化方案。
```
...
请提供完整的微服务项目结构和核心代码实现，参考EST的MICROSERVICES_ARCHITECTURE.md。
```
...
你的工作流程：
1. 理解用户需求
2. 参考EST文档（AI_CODER_GUIDE.md、AI_PROMPTS.md、PRACTICAL_EXAMPLES.md）
3. 生成符合EST最佳实践的代码
4. 提供代码说明和使用指南
...
请参考EST的ARCHITECTURE.md和MICROSERVICES_ARCHITECTURE.md。
```
