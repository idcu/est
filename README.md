...
EST 是一�?独立*的现�?Java 框架，采用渐进式架构设计，支持企业级应用开发、AI 集成、微服务架构等多种场景�?
- **版本**: 2.3.0
- **项目**: EST
- **作�?*: idcu
- **许可�?*: MIT License
...
我们很高兴地宣布 **EST Framework 2.3.0** 正式发布！
...
## 🎯 核心特�?
### 🍎 模块化架�?- **分层设计**: 核心�?�?基础�?�?模块�?�?应用�?�?工具�?- **按需引入**: 想用哪个功能就引入哪个模块，不会有多余的代码
- **API 与实现分�?*: 所有框架都采用 api/impl 分离的设计架�?
### 🏵�?独立设计
EST 框架不依赖任何第三方库，所有功能都是用 Java 标准库实现的�?- JSON处理、XML处理、YAML处理
- 加密、数据库访问、并发编�?- HTTP服务器、WebSocket支持
...
### 🔒 企业级安�?- JWT、OAuth2、API Key 认证
- RBAC 权限管理
- 审计日志
- 多租户支�?
### 🧰 丰富的功能组�?- **数据访问**: JDBC、Redis、MongoDB、内存存�?- **缓存系统**: 内存缓存、文件缓存、Redis 缓存
- **消息系统**: Kafka、RabbitMQ、WebSocket、本地事�?- **任务调度**: 固定频率、Cron 表达�?- **监控体系**: JVM 监控、系统监控、分布式追踪
- **微服�?*: 断路器、服务发现、性能
- **工作�?*: 工作流引擎支�?
### 👨‍�?开发工�?- CLI 命令行工�?- 代码生成�?- 脚手架生成器
- 迁移工具

### 🖥�?后台管理系统
- 基于 Vue 3 + Element Plus 的现代化 UI
- 用户、角色、菜单、部门、租户管�?- 操作日志、登录日�?- 系统监控、缓存监�?- 第三方集成（邮件、短信、OSS�?- AI 助手集成

### 🏗�?部署支持
- Docker 容器化部�?- Docker Compose 编排
- Kubernetes 部署配置
- Service Mesh 支持
- CI/CD 流水�?
---
...
```
est/
├── est-core/              # 核心�?�?  ├── est-core-container/    # 依赖注入容器
�?  ├── est-core-config/       # 配置管理
�?  ├── est-core-lifecycle/    # 生命周期管理
�?  ├── est-core-module/       # 模块管理
�?  ├── est-core-aop/          # AOP支持
�?  └── est-core-tx/           # 事务管理
├── est-base/              # 基础�?�?  ├── est-utils/         # 工具模块（JSON、XML、IO等）
�?  ├── est-patterns/      # 设计模式
�?  ├── est-collection/    # 集合框架
�?  └── est-test/          # 测试支持
├── est-modules/           # 功能模块�?�?  ├── est-foundation/    # 基础设施（缓存、日志、事件、监控等�?�?  ├── est-data-group/    # 数据访问（JDBC、Redis、MongoDB、工作流�?�?  ├── est-security-group/ # 安全权限（认证、RBAC、审计）
�?  ├── est-web-group/     # Web框架（路由、网关、会话、模板）
�?  ├── est-ai-suite/      # AI套件（LLM、AI助手、AI配置�?�?  ├── est-microservices/ # 微服务（断路器、服务发现、性能�?�?  ├── est-integration-group/ # 集成（消息系统、第三方集成�?�?  └── est-extensions/    # 扩展功能（热加载、插件、调度）
├── est-app/               # 应用�?�?  ├── est-web/           # Web应用框架
�?  ├── est-admin/         # 后台管理系统后端
�?  └── est-console/       # 控制台应�?├── est-admin-ui/          # 后台管理系统前端（Vue 3�?├── est-tools/             # 工具�?�?  ├── est-cli/           # 命令行工�?�?  ├── est-codegen/       # 代码生成
�?  ├── est-migration/     # 迁移工具
�?  └── est-scaffold/      # 脚手架生成器
├── est-examples/          # 示例代码
...
�?  ├── est-examples-microservices/ # 微服务示�?�?  └── est-examples-graalvm/    # GraalVM示例
├── est-demo/              # 演示应用
├── deploy/                # 部署配置
�?  ├── docker/            # Docker配置
�?  ├── k8s/               # Kubernetes配置
...
├── .config/               # 代码质量配置（Checkstyle、PMD、SpotBugs�?└── docs/                  # 文档
```
...
### 入门指南
- [快速开始](docs/getting-started/README.md) - 创建你的第一个应�?- [演示应用](est-demo/README.md) - 完整的功能展�?- [快速开始指南](est-demo/QUICKSTART.md) - 5分钟上手
- [编码规范](ENCODING_GUIDELINES.md) - 项目编码规范和最佳实�?
### 教程列表
- [入门教程](docs/tutorials/beginner/) - 适合初学�?- [Web 开发教程](docs/tutorials/) - 学习 Web 开�?
### 模块文档
...
### API 参�?- [API 文档中心](docs/README.md) - 完整的文档索�?- [示例代码](est-examples/) - 丰富的示例代�?
### 更多
...
public class HelloWorld {
    public static void main(String[] args) {
        WebApplication app = Web.create("我的第一个应�?, "1.0.0");
