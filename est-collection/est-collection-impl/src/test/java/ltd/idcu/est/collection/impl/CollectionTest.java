...
public class CollectionTest {
    ...
    public void testSumByDouble() {
        ...
        Assertions.assertEquals(7.0, pairs.sumByDouble(Pair::getValue), 0.001);
    }
    ...
    public void testAverageByDouble() {
        ...
        Assertions.assertEquals(4.0, pairs.averageByDouble(Pair::getValue), 0.001);
    }
    ...
    public void testFlatten() {
        Collection<List<Integer>> nested = Collections.of(
            Arrays.asList(1, 2),
            Arrays.asList(3, 4, 5)
        );
        Collection<Integer> flattened = nested.flatten();
