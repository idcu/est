...
public class DefaultTenantService implements TenantService {
    ...
    public Tenant createTenant(String name, String code, String domain, Tenant.TenantMode mode, 
        ...
        if (tenantsByCode.containsKey(code)) {
            throw new RbacException("Tenant code already exists: " + code);
        }
        if (domain != null && tenantsByDomain.containsKey(domain)) {
            throw new RbacException("Tenant domain already exists: " + domain);
        }
    ...
    public Tenant updateTenant(String id, String name, String domain, boolean active, long expiresAt) {
        ...
        if (existingTenant == null) {
            throw new RbacException("Tenant not found: " + id);
        }
    ...
    public void setCurrentTenant(String tenantId) {
        ...
        if (tenant == null) {
            throw new RbacException("Tenant not found: " + tenantId);
        }
        if (!tenant.isActive()) {
            throw new RbacException("Tenant is not active: " + tenantId);
        }
