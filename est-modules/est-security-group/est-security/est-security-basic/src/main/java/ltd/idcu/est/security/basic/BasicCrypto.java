...
public class BasicCrypto implements Crypto {
    ...
    private SecretKey deriveKeyFromSecret(String secret) {
        try {
            ...
            throw new ltd.idcu.est.security.api.SecurityException("Failed to derive key from secret", "KEY_DERIVATION_ERROR", e);
        }
    }
    ...
    public String encrypt(String plainText) {
        try {
            ...
            throw new ltd.idcu.est.security.api.SecurityException("Encryption failed", "ENCRYPTION_ERROR", e);
        }
    }
    ...
    public String decrypt(String cipherText) {
        try {
            ...
            if (cipherTextWithIv.length < GCM_IV_LENGTH) {
                throw new ltd.idcu.est.security.api.SecurityException("Invalid cipher text", "INVALID_CIPHER_TEXT");
            }
        ...
        } catch (ltd.idcu.est.security.api.SecurityException e) {
            throw e;
        } catch (Exception e) {
            throw new ltd.idcu.est.security.api.SecurityException("Decryption failed", "DECRYPTION_ERROR", e);
        }
    }
    ...
    public String hash(String input) {
        try {
            ...
            throw new ltd.idcu.est.security.api.SecurityException("Hashing failed", "HASH_ERROR", e);
        }
    }
    ...
    public String sign(String data) {
        try {
            ...
            throw new ltd.idcu.est.security.api.SecurityException("Signing failed", "SIGN_ERROR", e);
        }
    }
    ...
    private SecretKey generateSecretKeyInternal() {
        try {
            ...
            throw new ltd.idcu.est.security.api.SecurityException("Key generation failed", "KEY_GENERATION_ERROR", e);
        }
    }
    ...
    public KeyPair generateKeyPair() {
        try {
            ...
            throw new ltd.idcu.est.security.api.SecurityException("Key pair generation failed", "KEY_PAIR_GENERATION_ERROR", e);
        }
    }
    ...
    public void importPublicKey(String keyStr) {
        try {
            ...
            throw new ltd.idcu.est.security.api.SecurityException("Public key import failed", "KEY_IMPORT_ERROR", e);
        }
    }
    ...
    public void importPrivateKey(String keyStr) {
        try {
            ...
            throw new ltd.idcu.est.security.api.SecurityException("Private key import failed", "KEY_IMPORT_ERROR", e);
        }
    }
