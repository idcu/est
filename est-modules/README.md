...
**传统方式**：每次做饭都要自己准备所有东西，很麻烦。

**EST Modules 方式**：给你一个装满功能模块的超市，里面有：
- 🏗️ **基础设施** - 缓存、事件、日志、配置、监控、追踪
- 🗄️ **数据访问** - 数据存储、工作流引擎
- 🔐 **安全权限** - 认证授权、RBAC、审计
- 📨 **消息集成** - 消息队列、系统集成
- 🌐 **Web 框架** - 路由、网关、中间件
...
- **est-llm** - LLM 提供商实现（OpenAI、智谱、通义千问、文心一言、豆包、Kimi、Ollama）
