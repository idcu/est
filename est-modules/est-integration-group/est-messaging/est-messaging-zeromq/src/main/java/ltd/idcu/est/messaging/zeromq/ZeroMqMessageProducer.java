...
public class ZeroMqMessageProducer implements MessageProducer {
    
    private final ZeroMqConnection connection;
    private volatile boolean closed;
    
    public ZeroMqMessageProducer(ZeroMqConnection connection) {
    ...
    public void send(String topic, Object body) {
        ...
        connection.publish(topic, bodyBytes);
    }
